...
local plugins = lush(function()
  return {
    ...
    AerialFileIcon({ base.Green }),
    AerialModuleIcon({ base.Purple }),
    AerialNamespaceIcon({ base.Purple }),
    AerialPackageIcon({ base.Purple }),
    AerialClassIcon({ base.Yellow }),
    AerialMethodIcon({ base.Blue }),
    AerialPropertyIcon({ base.Red }),
    AerialFieldIcon({ base.Blue }),
    AerialConstructorIcon({ base.Blue }),
    AerialEnumIcon({ base.Yellow }),
    AerialInterfaceIcon({ base.Yellow }),
    AerialFunctionIcon({ base.Green }),
    AerialVariableIcon({ base.Red }),
    AerialConstantIcon({ base.Red }),
    AerialStringIcon({ base.Cyan }),
    AerialNumberIcon({ base.Cyan }),
    AerialBooleanIcon({ base.Cyan }),
    AerialArrayIcon({ base.Cyan }),
    AerialObjectIcon({ base.Cyan }),
    AerialKeyIcon({ base.Red }),
    AerialNullIcon({ base.Cyan }),
    AerialEnumMemberIcon({ base.Cyan }),
    AerialStructIcon({ base.Yellow }),
    AerialEventIcon({ base.Cyan }),
    AerialOperatorIcon({ base.Cyan }),
    AerialTypeParameterIcon({ base.Yellow }),
